...
var BookSchema = new mongoose.Schema({
  title: String,
  reviews: [{ 
    user: {type: mongoose.Schema.Types.ObjectId, ref: 'User'}, // 'aaaaaaaaaaaaaa'
    comments: String
  }]
});
...
mongoose.connect(
  ...
  var bookPromise = Book.create({ 
    ...
    var userPromise = User.create([
      {_id: 'aaaaaaaaaaaaaaaaaaaaaaaa', username: 'aalabaster', fullName : 'Alice Alabaster',addresses: [{street: '123 Main St.',city: 'Springfield',state: 'CO',zip: 12345},{street: '789 Cactus St.',city: 'Scottsdale',state: 'AZ',zip: 56789}]},      
    ...
    return Book.find().populate({ path: 'reviews.user', select: 'fullName username' }); //.populate('reviews.user') 
  }).then(results => {  
